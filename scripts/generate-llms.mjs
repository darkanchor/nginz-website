...
function genLlms() {
  ...
  lines.push("- [/products/nginz-token](/products/nginz-token) — AI gateway inside your nginx. BSL-1.1 source-available licensing with provider routing, token governance, cost tracking, bounded cache policy, and prompt-side security.");
  lines.push("");
...
function genLlmsFull() {
  ...
  lines.push("- Tagline: AI gateway inside your nginx. Provider routing, token governance, cost tracking, bounded cache policy, and prompt-side security under BSL 1.1.");
