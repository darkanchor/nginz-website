...
- [Dynamic Upstreams](/docs/reference/modules/dynamic-upstreams) because it can use Consul as a live discovery source.
- [Health Checks](/docs/reference/modules/healthcheck) when discovered services still need readiness verification before traffic shifts.
- [njs Runtime](/docs/reference/modules/njs) for higher-level orchestration that combines KV and service discovery results.
